...
public class FileController {
    ...
    public FileController(final FileService fileService,
                          final FileMessageSender fileMessageSender) {
    ...
    void processFile(@RequestParam("file") MultipartFile file) throws IOException {
        final FileSplitting fileSplitting = fileService.splitFileBySize(file.getInputStream(), Integer.parseInt(maxChunkSize));
