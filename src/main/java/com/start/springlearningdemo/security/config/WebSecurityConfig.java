...
public class WebSecurityConfig {
  ...
  public WebSecurityConfig(
      final TokenProvider tokenProvider, final AuthorizationProvider authorizationProvider) {
  ...
  private JwtAuthenticationProcessingFilter getJwtAuthProcessingFilter() {
    JwtAuthenticationProcessingFilter jwtAuthenticationProcessingFilter =
        new JwtAuthenticationProcessingFilter(
            getJwtRequestMatcher(), getJwtAuthenticationProvider());
    ...
    return new AndRequestMatcher(
        (new NegatedRequestMatcher(
            new OrRequestMatcher(
                new AntPathRequestMatcher("/login"), new AntPathRequestMatcher("/health")))),
